...
# Date: 06/11/2024
# Version: R 4.3.0
# File name: 10_Shingrix_Covariates.R
# Status: Complete
...
# Data sets created: 
## Full_data
# Description of file: Finds all patients covariates
# Actions:
## Subset medical/drug records to only be past 1st Jan 2011
## Link relevant patient ids to their medical/prodcut records
################################################################################
    ...
    Shingrix_full=read_rds(paste0(processed_data, "Shingrix_Risks.rds" ))
    ...
    Smoking2 <- Shingrix_full[c("patid", "min_entry")] %>%
    ...
    write_rds(Shingrix_full, paste0(processed_data, "Shingrix_Cov.rds" ))
